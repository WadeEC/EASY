...
export const api = {
  ...
  tidyPreview: (type) => jbody("/api/cleanup", { action: "tidy_preview", type: type || null }),
  tidyApply: (type) => jbody("/api/cleanup", { action: "tidy", type: type || null }),
  resyncNamesPreview: (type) => jbody("/api/cleanup", { action: "resync_preview", type: type || null }),
  resyncNames: (type) => jbody("/api/cleanup", { action: "resync", type: type || null }),
  fieldClashPreview: (league, fields_count) => jbody("/api/cleanup", { action: "fields_preview", league: league || null, fields_count: fields_count || null }),
  fieldClashFix: (league, fields_count) => jbody("/api/cleanup", { action: "fields", league: league || null, fields_count: fields_count || null }),
  ...
  gameAdd: (b) => jbody("/api/schedule", { action: "add_game", ...b }),
  ...
  weekCountSet: (count) => jbody("/api/settings/checkin-week", { action: "count", count }),
  weekCountPreview: (count) => jbody("/api/settings/checkin-week", { action: "count", count, dry_run: true }),
  ...
  renameTeam: (from, to, league = null) => jbody("/api/teams", { action: "rename", from, to, league }),
