...
// STRICT season match: a record belongs to exactly one season. Untagged
// (legacy) records belong to the special "(no season)" bucket — they show only
// there or under "All seasons", never inside a named season.
