...
export const PAGE_PROMPTS = {
  ...
  master: [
    "Export this season's master spreadsheet",
    "Filter to one district",
    "Show only added rows",
  ],
  unassigned: [
    "Who has no team this season?",
    "Put everyone with no division into the right age bracket",
    "Move the no-league players into Saturday Limerick",
  ],
  seasons: [
    "Start next season with the same leagues",
    "Bring last season's players into this one",
    "Export this league as Excel",
    "What still needs fixing across seasons?",
  ],
  standings: [
...
export const PAGE_LABEL = {
  ...
  unassigned: "this season's Unassigned list",
  seasons: "Seasons & Export",
